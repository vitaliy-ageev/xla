...
const Star: FunctionComponent = (props) => {
    return (
        <svg className={classes.star} version="1.1" x="0px" y="0px" width="475.075px" height="475.075px" viewBox="0 0 475.075 475.075" style={{ background: "new 0 0 475.075 475.075" }} xmlSpace="preserve">
            <g>
