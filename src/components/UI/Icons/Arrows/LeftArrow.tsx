...
const LeftArrow: FunctionComponent<LeftArrowProps> = (props) => {
    return (
        <div className='arrows-gallery left' onClick={props.onClick}>
            <svg className='arrow-gallery left' xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
